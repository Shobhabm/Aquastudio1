...
CREATE TABLE FinancialApp.CurrencyConversion (
    id INT PRIMARY KEY,
    sourceCurrency CHAR(3) NOT NULL REFERENCES FinancialApp.Currency(currencyCode),
    destCurrency CHAR(3) NOT NULL REFERENCES FinancialApp.Currency(currencyCode),
...
----------------------------------------------------------------------------
-- Example 6
ALTER TABLE FinancialApp.Sales ADD CONSTRAINT validCurrency CHECK (0=0);
GO
